...
function getCountry(country) {
    return __awaiter(this, void 0, void 0, function () {
        var getApi, countryData, requiredData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.com/v3.1/name/".concat(country))];
                case 1:
                    getApi = _a.sent();
                    countryData = getApi.data[0];
                    requiredData = {
...
function getRegionCapitals(region) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1.default)("https://restcountries.com/v3.1/region/".concat(region))];
                case 1:
                    getApi = _a.sent();
                    data = getApi.data;
                    capitals = [];
