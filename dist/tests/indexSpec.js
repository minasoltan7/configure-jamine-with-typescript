...
it("should get capitals of AFRICA countries", function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, index_1.default.getRegionCapitals('africa')];
            case 1:
                data = _a.sent();
                expect(data).toEqual([
...
it("should get all countries in Europe", function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
